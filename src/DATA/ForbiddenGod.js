const forbiddenGod = {
  ...
  list: [
    ...
    },
    {
      ...
      attacks: ['Bite: STR', 'Rusted Rapier: 1d8 + STR, Reliability 16'],
    ...
    },
    {
      ...
      attacks: ['Bite: STR', 'Rapier: STR + 1d8, Always hits Gizzards'],
      note: 'Maim head to kill, Armored Areas: 1, Destroyed after 1 hit',
    },
    {
      ...
      attacks: ['Hold: STR vs STR', 'Curse: SPR vs SPR: -2 all rolls for 1h'],
      note: 'Maim head to kill',
    },
  ],
};
