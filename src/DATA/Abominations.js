  ...
  list: [
    {
      ...
      attacks: ['Bite: STR+1d10 x3 attacks', 'Tentacles: STR, may attack with each of its 8 tentacles'],
    ...
    },
    {
      ...
      attacks: ['Bite: STR, Claws: STR + 1d6', 'Infection'],
    ...
    },
    {
      ...
      attacks: ['Bite: 1d4 + Poison', 'Poison: Vigor TN 5 : Paralyze 1d6 hours'],
      note: '',
    },
    {
      ...
      attacks: ['Bite: STR + Poison (Vigor TN9)', 'Poison: 1d6. Fail: 2d6 to guts and location per round'],
      note: '',
    },
    {
      name: 'Mutated Rat',
      ...
      attacks: ['Bite: STR + disease', 'Disease: Vigor TN9: Ghost Rock Fever', 'Terror 9 on first sight'],
      note: '',
    },
    {
      name: 'Baby Rattler',
    ...
    },
    {
      ...
      attacks: ['Bite: STR + 2d20', 'Surprise'],
      note: 'Armor 1',
    },
    {
      name: 'Mojave Rattler',
    ...
    },
    {
      ...
      attacks: ['Fear Attack', 'Incorporeal Attack'],
    },
  ],
};
