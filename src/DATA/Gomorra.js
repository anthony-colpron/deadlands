  ...
  list: [
    ...
    },
    {
      ...
      attacks: [
        ...
        'DA Peacemaker: 3d6',
        'Winchester 76: 4d8 +2',
        'Rifle Butt: STR + 1d6, DR: 1',
        'Bayonet: STR + 2d6, DR: 2',
        'MKII grenades: 3d12',
        'Groin Shot',
        'Unarm',
      ],
    ...
    },
    {
      ...
      attacks: ['No weapon', 'Knife: STR + 1d4', 'Pistol: 3d6', 'Derringer: 3d6'],
    },
    {
      ...
      attacks: ['No weapon', 'Knife: STR + 1d4', 'Pistol: 3d6', 'Dynamite x 6'],
    },
    {
      name: 'Adam Hart',
      pace: 8,
    ...
    },
    {
      ...
      attacks: ['No weapon', 'Tomahawk: STR + 2d6', 'Bowie Knife: STR + 1d6', 'Winchester 73: 4d8', 'Bow: STR + 1d6'],
